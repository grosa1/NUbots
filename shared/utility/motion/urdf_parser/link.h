...
namespace urdf {
    struct Material {
        ...
        Material(const Material& m) : name(m.name), texture_filename(m.texture_filename), color(m.color) {}
    ...
    struct Inertial {
        ...
        Inertial(const Inertial& i)
            : origin(i.origin), ixx(i.ixx), ixy(i.ixy), ixz(i.ixz), iyy(i.iyy), iyz(i.iyz), izz(i.izz), mass(i.mass) {}
