...
function(NUCLEAR_MODULE)
  ...
  foreach(data_file ${data_files})
    ...
    set(NUCLEAR_MODULE_DATA_FILE_SOURCES
        ${NUCLEAR_MODULE_DATA_FILE_SOURCES} ${data_file}
        CACHE INTERNAL "A list of all source files that were used to generate data files by modules" FORCE
    )

    set(NUCLEAR_MODULE_DATA_FILE_TARGETS
        ${NUCLEAR_MODULE_DATA_FILE_TARGETS} ${output_file}
  ...
  foreach(data_file ${MODULE_DATA_FILES})
    ...
    set(NUCLEAR_MODULE_DATA_FILE_SOURCES
        ${NUCLEAR_MODULE_DATA_FILE_SOURCES} ${input_file}
        CACHE INTERNAL "A list of all source files that were used to generate data files by modules" FORCE
    )
